...
const Navcontact = ({ showContact, closeContact }) => {
  ...
  return (
    <motion.div
      className="w-1/5 max-h-screen h-screen bg-primary-1 p-2 fixed top-0 right-0 flex flex-col z-50 border-l-black border-2"
    ...
    >
      ...
      >
        <IoClose className="text-3xl fill-white hover:scale-75 duration-300 mouse-affected" />
      </motion.div>
