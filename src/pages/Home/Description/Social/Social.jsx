      ...
      <span className="flex lg:flex-row sm:gap-2 lg:gap-4 sm:flex-col sm:items-center">
        {socialArr.map((social, idx) => (
          <Link
            ...
            key={idx}
            to={social.link}
            className={`${animated ? 'il-slide' : ''} flex gap-2 text-primary-4 w-fit items-center hover:brightness-150 duration-75 transition-[filter]`}
          >
